...
class Editprofiladmin extends MY_Controller {
    ...
    public function edit()
    {
        if($this->session->userdata('akses')=='Admin'){
            if($this->session->userdata['id_petugas']){
                ...
                $this->template->load('layoutadmin', 'editprofil/editprofil_admin', $data);
            }
            else{
                ...
                if(!empty($_FILES['userfile']['name'])) {
                    ...
                    if($this->form_validation->run()==true){
                        ...
                        if ($this->upload->do_upload('userfile')){
                            ...
                            unlink('assets/img/admin/'.$g['image']);
                        ...
                        //apabila tidak ada gambar yg diupload
                            ...
                            $this->template->load('layoutadmin', 'editprofiladmin/editprofiladmin_create', $data);
                        } 
