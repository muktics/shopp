...
class Editprofilkasir extends MY_Controller {
    ...
    public function edit()
    {
        if($this->session->userdata('akses')=='Kasir'){
            if($this->session->userdata['id_petugas']){
                ...
                $this->template->load('layoutkasir', 'editprofil/editprofil_kasir', $data);
            }
            else{
                    ...
                    if(!empty($_FILES['userfile']['name'])) {
                        ...
                        if($this->form_validation->run()==true){
                            ...
                            //apabila tidak ada gambar yg diupload
                                ...
                                $this->template->load('layoutkasir', 'editprofilkasir/editprofilkasir_create', $data);
                            } 
