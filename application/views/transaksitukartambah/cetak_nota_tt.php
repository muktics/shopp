<head>
    <title>CETAK TRANSAKSI TUKAR TAMBAH</title>
    <meta charset="utf-8">    
        ...
        <!--<div class="modal-content">-->
            <div class="modal-body"><br />
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td><?php echo $tmptrttbyr->detail;?></td>
                            <td class="text-left"></td>
                            <td class="text-right"><?php echo rupiah($tmptrttbyr->harga_jual);?></td>
                        </tr>
                    </tbody>
                </table>              
                ...
                <table width="100%">
                    <tr>
                        <td width="300px" class="text-right">Total&emsp;&emsp;&emsp;&emsp;&nbsp;&emsp;&emsp;&nbsp; &nbsp;</td>
                        
                        <td class="text-right"><?php echo rupiah($totalharga);?></td>
                    </tr>
                    <tr>
                        <td width="300px" class="text-right">Harga Tukar Tambah</td>
                        <?php $totaltt +=$tmptrttbyr->harga_jual;
                            $subtotall = $totalharga - $totaltt;?>
                        <td class="text-right"><?php echo rupiah($totaltt);?></td>
                    </tr>
                    <tr>
                        <td width="300px" class="text-right">Sub Total&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        
                        <td class="text-right"><?php echo rupiah($subtotall);?></td>
                    </tr>
                    <tr>
                        <td width="300px" class="text-right">Tunai&emsp;&emsp;&emsp;&emsp;&nbsp;&emsp;&emsp;&nbsp;&nbsp;</td>                        
                        <td class="text-right"><?php echo rupiah($tmptrttbyr->tunai);?></td>
                    </tr>
                    <tr>
                        <td width="300px" class="text-right">Kembalian&emsp;&emsp;&emsp;&emsp;&nbsp;</td>
                        
                        <td class="text-right"><?php echo rupiah($tmptrttbyr->kembalian);?></td>
                    </tr>
                </table>
                ...
                <table width="100%">
                        ...
                        <tbody>
                            <tr>
                                <td><br><br><br><?php echo $tmptrttbyr->nama_pelanggan;?></td>
                                <?php endforeach;?>
