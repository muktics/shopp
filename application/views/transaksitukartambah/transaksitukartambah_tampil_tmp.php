<br><table class="table">
    ...
    <tr>
        <td colspan="4" class="text-left">&emsp;&emsp;Sub Total</td>
        <td colspan="1" class="text-right"><input readonly="readonly" type="text" name="stotal" class=" form-control text-right" onkeyup="sum();" id="stotal"  class="form-control"></td>
    </tr>
    <tr>
        <td colspan="4" class="text-left">&emsp;&emsp;Bayar</td>
        <td colspan="1" class="text-right"><input type="text" name="tunai" class=" form-control text-right" onkeyup="sum();" id="tunai"  class="form-control"></td>
    </tr>
    <?php //$kembali = $a - $totalharga?>
    <tr>
        <td colspan="4" class="text-left">&emsp;&emsp;Kembali</td>
        <td colspan="1" class="text-right"><input type="text" class="form-control text-right" id="kembalian"  name="kembalian" onkeyup="sum();" readonly="readonly" value="<?php //echo rupiah($kembali);?>" class="form-control"></td>
    </tr>
</table>
<script>
    ...
    var dengan_rupiah2 = document.getElementById('harga_jual');
    ...
    var dengan_rupiah3 = document.getElementById('stotal');
    dengan_rupiah1.addEventListener('keyup', function(e)
    {
        dengan_rupiah3.value = formatRupiah3(this.value);
    });
...
function sum() {
      ...
      var harga_jual1 = document.getElementById('harga_jual').value;
      var harga_jual = harga_jual1.split('.').join("");
      //var harga_jual = harga_jual1.replace(".","");
      var stotal1 = document.getElementById('stotal').value;
      var stotal = stotal1.split('.').join("");
      //var stotal = stotal1.replace(".","");
      //var	reverse = txtSecondNumberValue.toString().split('').reverse().join(''),
	        //ribuan 	= reverse.match(/\d{1,3}/g);
	        //ribuan	= ribuan.join('.').split('').reverse().join('');
        var subbtotal = totalHarga - harga_jual;            
        //document.getElementById('stotal').value = subbtotal;        
        document.getElementById('stotal').value = formatRupiah3(subbtotal.toString());     
        var subTotal = bayar - subbtotal;  
