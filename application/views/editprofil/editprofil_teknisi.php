<head>
    <title>Ubah Profil - Sistem Teknisi Amnotel</title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            ?>
            <?php echo form_open_multipart('editprofilteknisi/update', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <div class="btn-group pull-left">
                            <?php echo anchor('dashboardteknisi', 'Batal', array('class' => 'btn btn-danger')); ?>
                        </div>
                    </div>
                    <div class="col-sm-6">
