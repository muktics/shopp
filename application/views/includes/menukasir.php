...
<html lang="en" >
<?php $this->session->userdata('akses')=='2'?>
	<!-- begin::Head -->
						...
						<div class="m-stack__item m-brand  m-brand--skin-dark ">
							<div class="m-stack m-stack--ver m-stack--general">
								<div class="m-stack__item m-stack__item--middle m-brand__logo">
									<a href="dashboardkasir" class="m-brand__logo-wrapper">
										...
										<li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" data-dropdown-toggle="click">
											<a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
													<img src="<?php if($this->session->userdata['image']==""){echo base_url('assets/img/kasir/images.jpg');}else{echo base_url('assets/img/kasir/'.$this->session->userdata['image']);}?>" class="m--img-rounded m--marginless m--img-centered" alt=""/>
												</span>
														...
														<div class="m-dropdown__content">
															<ul class="m-nav m-nav--skin-light">
																...
																<li class="m-nav__item">
																	<a href="<?php echo base_url('editprofilkasir/edit/'.$this->session->userdata['id_petugas']) ?>" name="edit" class="m-nav__link">
		...
		>
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" data-menu-submenu-toggle="hover" >
								<a  href="dashboardkasir" class="m-menu__link ">
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"  data-menu-submenu-toggle="hover">
								<a  href="transaksikasir" class="m-menu__link">
									<i class="m-menu__link-icon fa fa-share-square fa-fw"></i>
									<span class="m-menu__link-text">
										Transaksi Pembelian
									</span>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"  data-menu-submenu-toggle="hover">
								<a  href="transaksitukartambah" class="m-menu__link">
									<i class="m-menu__link-icon fa fa-refresh fa-fw"></i>
									<span class="m-menu__link-text">
