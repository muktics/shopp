<head>
    <title>Ubah Data Karyawan Kasir - Administrator POS Amnotel</title>
...
<div class="row d-flex align-items-center">
				<div class="mr-auto col-md-4 mt-1 mb-1">
					<h6 class="m-subheader__title">
                        <label for=""><span><a href="<?php echo base_url('kasir'); ?>">Kasir</a> / Edit Kasir</span></label>
					</h6>
				</div>				
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            ?>
            <?php echo form_open_multipart('kasir/update', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <div class="btn-group pull-left">
                            <?php echo anchor('kasir', 'Batal', array('class' => 'btn btn-danger')); ?>
                        </div>
                    </div>
                    <div class="col-sm-6">
