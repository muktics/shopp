<head>
    <title>Data Karyawan Kasir - Administrator POS Amnotel</title>
</head>

<div class="row d-flex align-items-center">
				<div class="mr-auto col-md-4 mt-1 mb-1">
					<h5 class="m-subheader__title">
                       <label for=""><span><a href="<?php echo base_url('kasir'); ?>">Kasir</a> / Data Kasir</span></label>
					</h5>
				</div>
                        ...
                        <div class="col-md-12 order-2 order-xl-1">
                            <div class="form-group m-form__group row align-items-center">
                                ...
                                <div class="col-md-9 text-right">
                                    <a href="kasir/create" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
                ...
                <table class="m-datatable" id="html_table" width="100%">
                                <thead>
                                    <tr style="height: 56px;">
                                        ...
                                        <th class="text-center">NIP / KTP</th>
                                ...
                                ?>
                                    <tr style="height: 56px;">
                                        ...
                                        <td><?php if($row->image != "") { ?>
                                            <img src="<?php echo base_url('assets/img/kasir/'.$row->image);?>" width="100px" height="100px">
                                        <?php }else{ ?>
                                            <img src="<?php echo base_url('assets/img/kasir/images.jpg');?>" width="100px" height="100px">
                                        <?php } ?> 
                                        </td>
                                        ...
                                        <td class="text-center"><?php echo tgl_indonesia_lahir($row->tanggal_lahir);?></td>
                                        <td class="text-center"><?php echo $row->jk;?></td>
                                        <td class="text-center"><?php echo $row->nohp;?></td>
                                        <td class="text-center">
                                            <span style="width:113px">
                                                <a href="<?php echo base_url('kasir/edit/'.$row->id_petugas) ?>" name="edit" class="btn btn-success m-btn m-btn--icon btn-lg m-btn--icon-only">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                                <a href="#" name="<?php echo $row->full_name;?>" class="hapus btn btn-danger m-btn m-btn--icon btn-lg m-btn--icon-only deletekar" kode="<?php echo $row->id_petugas;?>"><i class="fa fa-trash"></i></a>
                                                <!--<a href="#" name="<?php echo $row->full_name;?>" class="btn btn-danger m-btn m-btn--icon btn-lg m-btn--icon-only deletekar" kode="<?php echo $row->id_petugas;?>">
                                                    <i class="fa fa-trash"></i>
                                                </a>-->
                                            </span>
                                        </td>
                                        <!--<td class="text-center">
                                            <a href="<?php echo base_url('kasir/edit/'.$row->id_petugas) ?>"><input type="submit" class="btn btn-success btn-xs" name="edit" value="Edit"></a>
                                            <a href="#" name="<?php echo $row->full_name;?>" class="hapus btn btn-danger btn-xs" kode="<?php echo $row->id_petugas;?>">Hapus</a>
                                        </td>-->
                                    </tr>
                                <?php $no++; } ?>    
                                </tbody>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <input type="hidden" name="idhapus" id="idhapus">
                <p>Apakah anda yakin ingin menghapus kasir <strong class="text-konfirmasi"> </strong> ?</p>
        </div>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#konfirmasi").click(function(){
            ...
            $.ajax({
                url:"<?php echo site_url('kasir/delete');?>",
                type:"POST",
                data:"kode="+kode,
                cache:false,
                success:function(html){
                    location.href="<?php echo site_url('kasir/index/delete-success');?>";
                }
            });
        });
    });
...
<!--begin::Page Vendors -->
<script src="http://localhost/sikost//assets/assets/vendors/custom/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>
		<!--end::Page Vendors --> 