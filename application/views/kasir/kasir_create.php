<head>
    <title>Tambah Karyawan Kasir - Administrator POS Amnotel</title>
...
<div class="row d-flex align-items-center">
				<div class="mr-auto col-md-4 mt-1 mb-1">
					<h6 class="m-subheader__title">
                        <label for=""><span><a href="<?php echo base_url('kasir'); ?>">Kasir</a> / Tambah Kasir</span></label>
					</h6>
				</div>				
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            ?>
            <?php echo form_open_multipart('kasir/insert', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                <div class="form-group">
                    <p class="col-sm-2 text-left">User </p>
                    <div class="col-sm-4">
                        <input type="text" name="jenis_user" readonly="readonly" class="form-control" placeholder="Kasir" value="Kasir"<?php echo set_value('jenis_user'); ?>>
                    </div>
                </div>
                <div class="form-group">
