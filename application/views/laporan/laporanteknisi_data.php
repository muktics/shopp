<head>
    <title>Laporan Teknisi - Administrator POS Amnotel</title>
    <style>
    div#loader {
        text-align: center;
        z-index: 9999;
...
<div class="row d-flex align-items-center">
				<div class="mr-auto col-md-4 mt-1 mb-1">
					<h5 class="m-subheader__title">
                       <label for=""><span><a href="<?php echo base_url('laporanteknisi'); ?>">Laporan</a> / Laporan Teknisi</span></label>
					</h5>
				</div>
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><strong>Detail Service</strong></h4>
        </div>
...
$(document).ready(function() {
    ...
    $("#tampilkan").click(function(){
        ...
        if(tanggal1 == "") {
            ...
            $.ajax({
                url:"<?php echo site_url('laporanteknisi/cari_laporanteknisi');?>",
                type:"POST",
     ...
     $('body').on('click', '.show-modal', function(){
        ...
        // $("#myModal3").modal("show");
        $.ajax({
                url:"<?php echo site_url('laporanteknisi/detail_laporanteknisi');?>",
                type:"POST",
