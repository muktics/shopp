        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <label class="col-lg-6">
                                : <?php echo $transaksitukartambah['id_transaksi'];?>
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-lg-6">
                                : <?php echo tgl_indonesia_transaksi($transaksitukartambah['tanggal_transaksi']);?>
                            </label>
                        </div>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php $totalharga=0;
                        foreach($detailtransaksitukartambah as $row):?>
                    <tr>
