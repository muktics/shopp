<head>
    <title>Laporan Tukar Tambah - Administrator POS Amnotel</title>
    <style>
        div#loader {
            text-align: center;
            z-index: 9999;
...
<div class="row d-flex align-items-center">
				<div class="mr-auto col-md-4 mt-1 mb-1">
					<h5 class="m-subheader__title">
                       <label for=""><span><a href="<?php echo base_url('laporantukartambah'); ?>">Laporan</a> / Laporan Tukar Tambah</span></label>
					</h5>
				</div>
...
$(document).ready(function() {
    ...
    $("#tampilkan").click(function(){
        ...
        if(tanggal1 == "") {
            ...
            $.ajax({
                url:"<?php echo site_url('laporantukartambah/cari_laporantukartambah');?>",
                type:"POST",
