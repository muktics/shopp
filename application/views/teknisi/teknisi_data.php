<head>
    <title>Data Karyawan Teknisi - Administrator POS Amnotel</title>
</head>
<div class="row d-flex align-items-center">
				<div class="mr-auto col-md-4 mt-1 mb-1">
					<h5 class="m-subheader__title">
                       <label for=""><span><a href="<?php echo base_url('teknisi'); ?>">Teknisi</a> / Data Teknisi</span></label>
					</h5>
				</div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12 order-2 order-xl-1">
                            <div class="form-group m-form__group row align-items-center">
                                ...
                                <a href="teknisi/create" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
                            ...
                            <table class="m-datatable" id="html_table" width="100%">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php if($row->image != "") { ?>
                                            <img src="<?php echo base_url('assets/img/teknisi/'.$row->image);?>" width="100px" height="100px">
                                        <?php }else{ ?>
                                            <img src="<?php echo base_url('assets/img/teknisi/images.jpg');?>" width="100px" height="100px">
                                        <?php } ?> 
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <span style="width:113px">
                                                <a href="<?php echo base_url('teknisi/edit/'.$row->id_petugas) ?>" name="edit" class="btn btn-success m-btn m-btn--icon btn-lg m-btn--icon-only">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                                <a href="#" name="<?php echo $row->full_name;?>" class="hapus btn btn-danger m-btn m-btn--icon btn-lg m-btn--icon-only deletekar" kode="<?php echo $row->id_petugas;?>">
                                        ...
                                        <!--<td class="text-center">
                                            <a href="<?php echo base_url('teknisi/edit/'.$row->id_petugas) ?>"><input type="submit" class="btn btn-success btn-xs" name="edit" value="Edit"></a>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <input type="hidden" name="idhapus" id="idhapus">
                <p>Apakah anda yakin ingin menghapus user teknisi <strong class="text-konfirmasi"> </strong> ?</p>
        </div>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#konfirmasi").click(function(){
            ...
            $.ajax({
                url:"<?php echo site_url('teknisi/delete');?>",
                type:"POST",
                data:"kode="+kode,
                cache:false,
                success:function(html){
                    location.href="<?php echo site_url('teknisi/index/delete-success');?>";
                }
            });
        });
    });
