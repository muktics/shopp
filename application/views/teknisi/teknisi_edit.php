<head>
    <title>Ubah Data Teknisi - Administrator POS Amnotel</title>
...
<div class="row d-flex align-items-center">
				<div class="mr-auto col-md-4 mt-1 mb-1">
					<h6 class="m-subheader__title">
                        <label for=""><span><a href="<?php echo base_url('teknisi'); ?>">Teknisi</a> / Edit Teknisi</span></label>
					</h6>
				</div>				
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            ?>
            <?php echo form_open_multipart('teknisi/update', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="password" data-toggle="password" name="password" class="form-control" placeholder="Password" value="<?php echo $edit['password'] ?>">
                    </div>
                </div>-->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="nohp" class="form-control" placeholder="Asal"  value="<?php echo $edit['nohp']; ?>">
                    </div>
                </div>
                <div class="form-group">																
