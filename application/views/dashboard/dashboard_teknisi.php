<head>
    <title>Dashboard - Sistem Teknisi Amnotel</title>
...
<div class="row d-flex align-items-center">
        ...
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="col-xl-4">
					<div class="m-portlet m-portlet--mobile" style="background: linear-gradient(230deg, #157, #255)">
						<div class="m-portlet__body " style="color: #fff!important">
							<div class="row align-items-center">
								<div class="col-8">
									<h5>Dalam Proses</h5>
									<h3 class="num-dashboard"><?php echo $counttransaksiteknisiproses; ?></h3>
								</div>
								<div class="col-4">
                ...
                <div class="col-xl-4">
					<div class="m-portlet m-portlet--mobile" style="background: linear-gradient(230deg, #255, #191)">
						<div class="m-portlet__body " style="color: #fff!important">
							<div class="row align-items-center">
								<div class="col-8">
									<h5>Service Selesai</h5>
									<h3 class="num-dashboard"><?php echo $counttransaksiteknisiselesai; ?></h3>
								</div>
								<div class="col-4">
